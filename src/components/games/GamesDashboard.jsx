...
const GamesDashboard = () => {
    ...
    return (
        <div className={`h-[94%] lg:h-[90%] w-[96%] md:w-[90%] ${game !== "Scratchers" ? 'lg:w-[80%] xxl:w-[70%]' : 'lg:w-[90%] xxl:w-[85%]'} lg:w-[80%] xxl:w-[70%] tall:p-[4px] z-50 overflow-hidden`}>
            <div className="h-full w-full bg-dark flex flex-col md:flex-row">
                <div className="flex md:flex-col md:w-[90px] md:h-full h-[10%] w-full ml-auto mr-auto gap-[1rem] md:gap-[2px] px-[10px] md:px-[2px] md:py-[2px]  items-center md:items-start justify-around borderBottom1">
                    <motion.h3
                        ...
                        className={`${game === 'Keno' ? 'active1' : ''
                            } w-[70px] shadow3 h-[40px] md:h-[120px] leading-[40px] md:leading-[120px] text-[12px] text-center text-lightGreen cursor-pointer`}
                    ...
                    <motion.h3
                        whileHover={{ backgroundColor: '#0D9B5C' }}
                        className={`${game === 'Numbers' ? 'active1' : ''
                            } w-[70px] shadow3 h-[40px] md:h-[120px] leading-[40px] md:leading-[120px] text-[12px] px-[4px] text-center text-lightGreen cursor-pointer`}
                        onClick={(e) => changeGame(e)}
                    >
                        Numbers
                    </motion.h3>
                    <motion.h3
                        whileHover={{ backgroundColor: '#0D9B5C' }}
                        className={`${game === 'Powerball' ? 'active1' : ''
                            } w-[70px] shadow3 h-[40px] md:h-[120px] leading-[40px] md:leading-[120px] text-[12px] px-[4px] text-center text-lightGreen cursor-pointer`}
                        onClick={(e) => changeGame(e)}
                    >
                        Powerball
                    ...
                    <motion.h3
                        whileHover={{ backgroundColor: '#0D9B5C' }}
                        className={`${game === 'Scratchers' ? 'active1' : ''
                            } w-[70px] shadow3 h-[40px] md:h-[120px] leading-[40px] md:leading-[120px] text-[12px] px-[4px] text-center text-lightGreen cursor-pointer`}
                        onClick={(e) => changeGame(e)}
                    >
                        Scratchers
                ...
                <div className="h-full w-full flex flex-col md:py-[10px] md:pr-[10px] overflow-y-scroll">
                    ...
                    {/* PLAY BOXES */}
                    <div
                        className={`bg-darkGreen w-full ${showKenoRegHistoryModalRedux ? 'h-[55%]' : 'h-3/5'
                            }
            `}
                    >
                        {game === 'Keno' ? (
                    ...
                    {/* STAT BOXES */}
                    <div
                        className={`bg-dark w-full ${showKenoRegHistoryModalRedux ? 'h-[20%]' : 'h-1/5 flex-1'
                            }`}
                    >
                        {game === 'Keno' ? (
                            <KenoStatBox />
